...
const { StringSelectMenuBuilder, SelectMenuOptionBuilder, ActionRowBuilder, EmbedBuilder, ApplicationCommandOptionWithChoicesAndAutocompleteMixin, ButtonBuilder, StringSelectMenuOptionBuilder } = require("@discordjs/builders")
...
async function setup(interaction) {
    ...
    const ticketCreationEmbed = new EmbedBuilder()
        .setColor(0x454FBF ) // discord blurple
...
async function createTicket(interaction, potentialModule) {
